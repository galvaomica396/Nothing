param(
  ...
  [string]$InstallerPath = "release-windows\Nothing-4.6.1-windows-x64-setup.exe",
  [string]$WorkDir = "",
...
$appExe = Resolve-RequiredPath -Path (Join-Path $releasePath "Nothing-4.6.1-windows-x64.exe") -Description "packaged Tauri executable"
